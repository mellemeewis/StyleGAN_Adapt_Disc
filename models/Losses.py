...
class LogisticGAN(GANLoss):
    ...
    def vae_loss(self, real_samps, height, alpha, print_=False):
        ...
        dis_hidden_layer_real = self.dis(reconstrution, height, alpha, use_for_recon_error=True)
        ...
        recon_loss= F.mse_loss(dis_hidden_layer_real, dis_hidden_layer_real, ruductoion=None).mean(dim=(1,2,3), keepdim=True)
